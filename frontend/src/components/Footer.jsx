        ...
        <div className="container text-md-left">
          <div className="row text-md-left">
            ...
            <div className="col-md-3 col-lg-3 col-xl-3 mx-auto mt-3">
              <h5 className="text-uppercase mb-4 font-weight-bold">Dhandapani Jewellery</h5>
              <i className="fas fa-qrcode fa-2x mb-3"></i><br />
            ...
            <div className="col-md-2 col-lg-2 col-xl-2 mx-auto mt-3">
              ...
              <p><a href="#" className="text-white text-decoration-none">Delivery Information</a></p>
              <p><a href="#" className="text-white text-decoration-none">International Shipping</a></p>
              <p><a href="#" className="text-white text-decoration-none">Payment Options</a></p>
              ...
              <p><a href="#" className="text-white text-decoration-none">Find a Store</a></p>
            </div>
            ...
            <div className="col-md-2 col-lg-2 col-xl-2 mx-auto mt-3">
              ...
              <p><a href="#" className="text-white text-decoration-none">Offers & Contest Details</a></p>
              <p><a href="#" className="text-white text-decoration-none">Help & FAQs</a></p>
              <p><a href="#" className="text-white text-decoration-none">About Dhandapani Jewellery</a></p>
            ...
            <div className="col-md-3 col-lg-3 col-xl-3 mx-auto mt-3">
              ...
              <p><i className="fas fa-phone me-2"></i>1800-266-0123</p>
              <p><i className="fas fa-comment-dots me-2"></i>+91 8147349242</p>
              <p>
          ...
          <div className="row text-center mt-4">
            <div className="col-md-6">
              ...
              <a href="#"><i className="fab fa-instagram fa-lg text-white me-3"></i></a>
              <a href="#"><i className="fab fa-twitter fa-lg text-white me-3"></i></a>
              <a href="#"><i className="fab fa-facebook fa-lg text-white me-3"></i></a>
              <a href="#"><i className="fab fa-youtube fa-lg text-white"></i></a>
            </div>
            <div className="col-md-6">
          ...
          <div className="row mt-4">
            <div className="col text-center">
              <p className="mb-1">© 2025 Dhandapani Jewellery. All Rights Reserved.</p>
              <p>
                ...
                <a href="#" className="text-white text-decoration-none">Disclaimer</a>
              </p>
            </div>
          </div>
        </div>
