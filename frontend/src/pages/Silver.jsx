...
const SilverPage = () => {
  ...
  useEffect(() => {
    fetch(`${URL}/api/products/silver`)
      ...
      .catch((err) => {
        console.error("Error fetching silver items:", err);
        setLoading(false);
      });
  }, []);

  // Filter items based on search and subcategory
  const filteredItems = silverItems.filter((item) => {
  ...
  return (
    <>
      <div>
        ...
        >
          <i>
            Crafted by experts, <strong>cherished by you</strong>
          </i>
        </h1>
          ...
          <div className="row mb-4">
            <div className="col-md-6 mb-2">
              <input
                ...
                placeholder="Search for silver items..."
                value={searchTerm}
